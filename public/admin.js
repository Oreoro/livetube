...
async function refreshList() {
  ...
  $("#storageMode").textContent = data.persistent
  ? `persistent (${data.backend === "kv" ? "Cloudflare KV" : "Upstash Redis"})`
  : "in-memory (bind LIVETUBE_KV or set Upstash env vars for durability)";
